                    ...
                    <form>
                        <div className="p-4 bg-white rounded-xl mb-8 flex gap-4 items-start">
                            ...
                            <div className="text-sm">
                                <p className="mb-4">
                                    <strong>Você pode adicionar rapidamente um cliente apenas com seu número de telefone.</strong> O cliente poderá completar seu cadastro depois, agilizando seu atendimento.
                                </p>
                                <p className="mb-4">Aproveite também para adicionar rapidamente créditos a este usuário em seus cartões já cadastrados.</p>
                        ...
                        <h3 className="font-bold mb-4 text-center">Adicione rapidamente créditos</h3>
